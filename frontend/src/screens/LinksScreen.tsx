...
import { Plus, Copy, Check, Share2, ShieldCheck, Zap, Info, ArrowRight } from 'lucide-react';
import { useStore } from '@/store/useStore';
import { Button } from '@/components/ui/Button';
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-5">
            <div className="flex items-center justify-between px-2">
              ...
              <button className="text-[10px] font-display font-black text-[var(--accent)] uppercase tracking-[0.2em]">Archived →</button>
            </div>
                    ...
                    <div className="flex items-center justify-between mb-5">
                      <div className="space-y-1">
                        ...
                        <div className="text-[10px] text-[var(--accent)] font-display font-black uppercase tracking-[0.2em] opacity-80">
                          ≈ {formatCurrency(link.amount / 1450, 'USDT')}
                        </div>
                      </div>
